import { CheckCircle, Description, FiberManualRecord } from '@mui/icons-material'
...
{name:"Arriving" , description: " , 11 Jul" , value: "ARRIVING" },
         ...
         {statusStep.map((step,index)=>(
            ...
            <div key={index} className='{` flex px-4`}'>
                <div className='flex flex-col items-center'>
                    ...
                    { statusStep.length -1 !=index && ( <div className={`border h-20 w-[2px] ${index < currentStep? "bg-teal-500 " : "bg-gray-300 text-gray-600"}`}></div>)}
                </div>
